...
type ProjectInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/buttahtoast/provider-harbor/apis/namespaced/registry/v1alpha1.Registry
	// +crossplane:generate:reference:extractor=github.com/buttahtoast/provider-harbor/config/common.ExtractRegistryID()
